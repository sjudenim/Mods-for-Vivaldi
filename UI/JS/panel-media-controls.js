...
(function () {
  ...
  gnoh.addStyle([
    ...
    '.global-media-controls-content .item button { background-color: var(--colorBgLightIntense); color: var(--colorFg); padding: 0; width: 28px; height: 28px; border-radius: 14px; border: 0; padding-top: 4px; }',
    ...
    '.global-media-controls-content .item button svg { width: 16px; height: 16px; position: relative; }',
